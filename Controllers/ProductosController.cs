...
namespace MipequeniaTienda.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductoId,Codigo,Nombre,Modelo,Description,Precio,Imagen,CategoriaId,Stock,Marca,Activo")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductoId,Codigo,Nombre,Modelo,Description,Precio,Imagen,CategoriaId,Stock,Marca,Activo")] Producto producto)
        {
